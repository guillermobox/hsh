...
if &background == "dark"
  ...
  SynColor Statement	term=bold cterm=NONE ctermfg=LightYellow ctermbg=NONE gui=bold guifg=#ffff60 guibg=NONE
  ...
  SynColor Statement	term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE gui=NONE guifg=fg guibg=bg
  SynColor Preproc	term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE gui=NONE guifg=fg guibg=bg
