...
if &background == "dark"
  ...
  SynColor Constant	term=NONE cterm=NONE ctermfg=Black ctermbg=NONE gui=NONE guifg=Black guibg=NONE
  SynColor ConstantString	term=NONE cterm=NONE ctermfg=DarkGreen ctermbg=NONE gui=NONE guifg=fg guibg=bg
  SynColor Special	term=NONE cterm=NONE ctermfg=black ctermbg=NONE gui=NONE guifg=fg guibg=bg
  SynColor Identifier	term=NONE cterm=NONE ctermfg=Black ctermbg=NONE gui=NONE guifg=fg guibg=bg
  SynColor Statement	term=NONE cterm=NONE ctermfg=black ctermbg=NONE gui=NONE guifg=fg guibg=bg
  SynColor Preproc	term=NONE cterm=NONE ctermfg=black ctermbg=NONE gui=NONE guifg=fg guibg=bg
  SynColor Type		term=NONE cterm=NONE ctermfg=black ctermbg=NONE gui=NONE guifg=fg guibg=bg
  SynColor Underlined	term=underline cterm=underline ctermfg=black ctermbg=NONE gui=NONE guifg=fg guibg=bg
